...
@section('ajaxCalls')
    <script>
        var columns = [
            ...
            {data: 'id', name: 'id'},
            {date: 'user_id', name: 'user_id'},
            {date: 'case_id', name: 'case_id'},
            {date: 'user_type', name: 'user_type'},
            {date: 'rate', name: 'rate'},
            {date: 'comment', name: 'comment'},

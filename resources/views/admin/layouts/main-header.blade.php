...
{{--            </a>--}}
            <a aria-label="Hide Sidebar" class="app-sidebar__toggle" data-toggle="sidebar" href="#">
                <svg style="stroke:none;" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24">
...
{{--                            <i class=" mdi mdi-translate mb-0" style="font-size: 20px;color: #31363F !important;"></i>--}}
{{--                        </div>--}}
{{--                    </a>--}}
{{--                    <div--}}
...
{{--                </div>--}}
                ...
                <div class="dropdown profile-1">
                    @php
                            ...
                            :$photo = 'https://ui-avatars.com/api/?length=1&background=random&bold=true&color=ffff&name=' . $name;

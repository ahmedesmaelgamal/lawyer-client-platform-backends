                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-bordered text-nowrap w-100" id="dataTable">
                            ...
                            <tr class="fw-bolder text-muted bg-light">
                                ...
                                <th class="min-w-50px">{{ trns('user_type') }}</th>
                                <th class="min-w-50px">{{ trns('withdraw_method') }}</th>
                                <th class="min-w-50px">{{ trns('way') }}</th>
                                <th class="min-w-50px">{{ trns('amount') }}</th>
...
@section('ajaxCalls')
    <script>
        var columns = [
            ...
            {data: 'payment_key', name: 'payment_key'},

            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="">
                        ...
                        {{--                        </button>--}}
                        @can("update_court_case_management")
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-bordered text-nowrap w-100" id="dataTable">
                            ...
                            <tr class="fw-bolder text-muted bg-light">
                                ...
                                <th class="min-w-25px">{{trns('from_user')}}</th>
                                <th class="min-w-25px">{{trns('to_user')}}</th>
                                <th class="min-w-25px">{{trns('from_user_type')}}</th>
                                <th class="min-w-25px">{{trns('to_user_type')}}</th>
                                <th class="min-w-25px">{{trns('court_case')}}</th>
                                <th class="min-w-25px">{{trns('court_case_event_status')}}</th>
                                <th class="min-w-25px">{{trns(key: 'date')}}</th>
                                <th class="min-w-25px">{{trns(key: 'paid')}}</th>
...
@section('ajaxCalls')
    <script>
        var columns = [
            ...
            {data: 'from_user_type', name: 'from_user_type'},
            {data: 'to_user_type', name: 'to_user_type'},
            {data: 'court_case_id', name: 'court_case_id'},
            {data: 'court_case_event_id', name: 'court_case_event_id'},
            {data: 'date', name: 'date'},
            {data: 'paid', name: 'paid'},

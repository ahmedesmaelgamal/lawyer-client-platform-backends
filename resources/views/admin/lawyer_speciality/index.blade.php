        ...
        <div class="col-md-12 col-lg-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="">
                        @can("create_speciality_management")
                        ...
                        @endcan
                        @can("delete_speciality_management")
                            <button class="btn btn-danger btn-icon text-white" id="bulk-delete">
                                <span><i class="fe fe-trash"></i></span> {{ trns('delete selected') }}
                            </button>
                        @endcan
                        @can("update_speciality_management")
...
@section('ajaxCalls')
    <script>
        var columns = [
            ...
            {data: 'id', name: 'id'},
            {data: 'special_id', name: 'special_id', orderable: false, searchable: false},
            {data: 'lawyer_id', name: 'lawyer_id', orderable: false, searchable: false},

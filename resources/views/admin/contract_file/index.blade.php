        ...
        <div class="col-md-12 col-lg-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="">
                    @can("create_contract_files_management")
                    ...
                    @endcan
                    @can("delete_contract_files_management")
                        <button class="btn btn-danger btn-icon text-white" id="bulk-delete">
                            <span><i class="fe fe-trash"></i></span> {{ trns('delete selected') }}
                        </button>
                    @endcan
                    @can("update_contract_files_management")
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-bordered text-nowrap w-100" id="dataTable">
                            ...
                            <tr class="fw-bolder text-muted bg-light">
                                ...
                                <th class="min-w-25px">{{trns('file_name')}}</th>
                                <th class="min-w-25px">{{trns('file_extension')}}</th>
                                <th class="min-w-25px">{{trns('file')}}</th>
...
@section('ajaxCalls')
    <script>
        ...
        showData('{{route('contract_files_data',request('id'))}}', columns);
        ...
        // Add Using Ajax
        showAddModal('{{route($route.'.create',['id'=>request('id')])}}');
        addScript();
        // Add Using Ajax

            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="">
                        ...
                        @can("delete_lawyer_package_management")
                            <button class="btn btn-danger btn-icon text-white" id="bulk-delete">
                                <span><i class="fe fe-trash"></i></span> {{ trns('delete selected') }}
                            </button>
                        @endcan
                        @can("update_lawyer_package_management")
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-bordered text-nowrap w-100" id="dataTable">
                            ...
                            <tr class="fw-bolder text-muted bg-light">
                                ...
                                <th class="min-w-25px">{{ trns('start_date') }}</th>
                                <th class="min-w-25px">{{ trns('end_date') }}</th>
                                <th class="min-w-25px">{{ trns('number_of_bumps') }}</th>
                                <th class="min-w-25px">{{ trns('status') }}</th>
                                <th class="min-w-25px">{{ trns('is_expired') }}</th>
...
@section('ajaxCalls')
    <script>
        var columns = [
            ...
            {data: 'number_of_bumps', name: 'number_of_bumps'},

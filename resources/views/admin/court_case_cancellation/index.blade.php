                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-bordered text-nowrap w-100" id="dataTable">
                            ...
                            <tr class="fw-bolder text-muted bg-light">
                                ...
                                <th class="min-w-25px">{{trns('accept_lawyer')}}</th>
                                <th class="min-w-25px">{{trns('accept_client')}}</th>
...
@section('ajaxCalls')
    <script>
        var columns = [
            ...
            {data: 'accept_lawyer', name: 'accept_lawyer'},
            {data: 'accept_client', name: 'accept_client'},

        ...
        <div class="col-md-12 col-lg-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="">
                        @can('create_court_case_management')
            ...
            <div class="modal-dialog " role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <p>{{ trns('Please note that this item is linked to another table') }}
        ...
        <div class="modal fade" id="deleteConfirmModal" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>{{ trns('Please note that this item is linked to another table (Sub Case Specializations),

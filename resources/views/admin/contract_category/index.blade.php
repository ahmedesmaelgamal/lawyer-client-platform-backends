        ...
        <div class="col-md-12 col-lg-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="">
                        @can('create_contract_categorys_management')
                        ...
                        @endcan
                        @can('delete_contract_categorys_management')
                            <button class="btn btn-danger btn-icon text-white" id="bulk-delete">
                                <span><i class="fe fe-trash"></i></span> {{ trns('delete selected') }}
                            </button>
                        @endcan
                        @can('update_contract_categorys_management')
                        ...
                        <table class="table table-bordered text-nowrap w-100" id="dataTable">
                            <thead>
                                <tr class="fw-bolder text-muted bg-light">
                                    ...
                                    <th class="min-w-25px">{{ trns('contracts') }}</th>

                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-bordered text-nowrap w-100" id="dataTable">
                            ...
                            <tr class="fw-bolder text-muted bg-light">
                                ...
                                <th class="min-w-25px">{{ trns('email') }}</th>
                                {{--                                <th class="min-w-25px">{{trns('national')}}</th> --}}
                                ...
                                <th class="min-w-25px">{{ trns('type') }}</th>
                                <th class="min-w-25px">{{ trns('level') }}</th>
                                <th class="min-w-25px">{{ trns('wallet') }}</th>
                                {{-- <th class="min-w-25px">{{ trns('specialities') }}</th> --}}
                    ...
                    <div class="modal-body">
                        <form action="" id="filterForm" method="get">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" name="search_email" id="search_email">
                                            <option value="" selected disabled>select email</option>
                                            @foreach ($emails as $index=>$email)
                                                <option class="form-control" value="{{ $index }}">{{ $email }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" name="search_type" id="search_type">
                                            ...
                                            @foreach ($types as  $type)
                                                <option class="form-control"
                                                        value="{{ $type->value }}">{{ $type->lang() }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" name="search_level_id"
                                                id="search_level_id">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="button" id="filterButton" data-dismiss="modal" class="btn btn-primary">
                                    بحث
                                </button>
                            </div>
                        </form>
...
@section('ajaxCalls')
    <script>
        ...
        function cleanSearch() {
            ...
            $('#search_email').val(null).trigger('change');
        ...
        const ajax = {
            ...
            data: function (d) {
                d.search_name = $('select[name="search_name"]').val();
                d.search_email = $('select[name="search_email"]').val();

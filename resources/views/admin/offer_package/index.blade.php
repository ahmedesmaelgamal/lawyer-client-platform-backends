...
@endsection
@section('page_name')
    <a href="{{ route($route . '.index') }}">{{ $bladeName }}</a>
@endsection
@section('content')
    <div class="row">
        <div class="col-md-12 col-lg-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="">
                        @can('create_offer_package_management')
                        ...
                        @endcan
                        @can('delete_offer_package_management')
                            <button class="btn btn-danger btn-icon text-white" id="bulk-delete">
                                <span><i class="fe fe-trash"></i></span> {{ trns('delete selected') }}
                            </button>
                        @endcan
                        @can('update_offer_package_management')
                        ...
                        <table class="table table-bordered text-nowrap w-100" id="dataTable">
                            <thead>
                                <tr class="fw-bolder text-muted bg-light">
                                    ...
                                    <th class="min-w-25px">{{ trns('number_of_days') }}</th>
                                    <th class="min-w-25px">{{ trns('number_of_ads') }}</th>
                                    <th class="min-w-25px">{{ trns('price') }}</th>
                                    <th class="min-w-25px">{{ trns('discount') }}</th>

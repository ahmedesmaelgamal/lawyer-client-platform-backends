...
use App\Http\Requests\CourtCaseEventRequest as ObjRequest;
use App\Models\CourtCaseEvent as ObjModel;
use App\Services\Admin\CourtCaseEventService as ObjService;
use Illuminate\Http\Request;

class CourtCaseEventController extends Controller
{

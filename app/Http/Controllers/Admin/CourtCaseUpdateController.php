...
use App\Http\Requests\CourtCaseUpdateRequest as ObjRequest;
use App\Models\CourtCaseUpdate as ObjModel;
use App\Services\Admin\CourtCaseUpdateService as ObjService;
use Illuminate\Http\Request;

class CourtCaseUpdateController extends Controller
{

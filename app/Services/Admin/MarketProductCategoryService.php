...
class MarketProductCategoryService extends BaseService
{
    protected string $folder = 'admin/market_product_category';
    protected string $route = 'market_product_categories';
    ...
    {
        if (isset($data['image'])) {
            $data['image'] = $this->handleFile($data['image'], 'MarketProductCategory');
        }

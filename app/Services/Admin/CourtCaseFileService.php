...
use App\Models\CourtCaseFile as ObjModel;
use App\Services\BaseService;
use Illuminate\Support\Facades\Auth;
use Yajra\DataTables\DataTables;

class CourtCaseFileService extends BaseService
{
    protected string $folder = 'admin/court_case_file';
    protected string $route = 'court_case_files';
    ...
    {
        if (isset($data['image'])) {
            $data['image'] = $this->handleFile($data['image'], 'CourtCaseFile');
        }

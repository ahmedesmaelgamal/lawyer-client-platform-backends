...
class LawyerAboutService extends BaseService
{
    protected string $folder = 'admin/lawyer_about';
    protected string $route = 'lawyer_abouts';
    ...
    {
        if (isset($data['image'])) {
            $data['image'] = $this->handleFile($data['image'], 'LawyerAbout');
        }

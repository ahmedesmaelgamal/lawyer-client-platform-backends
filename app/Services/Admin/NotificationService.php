...
{
    protected string $folder = 'admin/notification';
    protected string $route = 'notifications';
        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($obj)
                ->addColumn('action', function ($obj) {
                    ...
                    if (Auth::user()->can("update_notification_management")) {
                        $buttons .= '
                    ...
                    if (Auth::user()->can("delete_notification_management")) {
                        $buttons .= '
    ...
    {
        if (isset($data['image'])) {
            $data['image'] = $this->handleFile($data['image'], 'Notificatio');
        }

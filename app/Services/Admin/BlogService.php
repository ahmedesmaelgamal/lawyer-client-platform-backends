...
{
    protected string $folder = 'admin/blog';
        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($obj)
                ->addColumn('action', function ($obj) {
                    ...
                    if (Auth::user()->can("update_blogs_management")) {
                        $buttons .= '
                    ...
                    if (Auth::user()->can("delete_blogs_management")) {
                        $buttons .= '
    ...
    {
        if (isset($data['image'])) {
            $data['image'] = $this->handleFile($data['image'], 'Blog');
        }

...
use App\Models\DeviceToken as ObjModel;
...
{
    protected string $folder = 'admin/device_token';
    protected string $route = 'device_tokens';
        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($obj)
                ->addColumn('action', function ($obj) {
                    ...
                    if (Auth::user()->can("update_device_token_management")) {
                        $buttons .= '
                    ...
                    if (Auth::user()->can("delete_device_token_management")) {
                        $buttons .= '
    ...
    {
        if (isset($data['image'])) {
            $data['image'] = $this->handleFile($data['image'], 'DeviceToken');
        }

...
use App\Models\Level as ObjModel;
...
{
    protected string $folder = 'admin/level';
    protected string $route = 'levels';
        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($obj)
                ...
                ->addColumn('action', function ($obj) {
                        $buttons = ' ';
                    if (Auth::user()->can("update_level_management")) {
                    ...
                    if (Auth::user()->can("delete_level_management")) {
    ...
    {
        if (isset($data['image'])) {
            $data['image'] = $this->handleFile($data['image'], 'Levels');
        }

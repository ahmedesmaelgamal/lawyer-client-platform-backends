...
use App\Models\Document as ObjModel;
...
{
    protected string $folder = 'admin/document';
        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($obj)
                ->addColumn('action', function ($obj) {
                    ...
                    if (Auth::user()->can("update_document_management")) {
                        $buttons .= '
                    ...
                    if (Auth::user()->can("delete_document_management")) {
                        $buttons .= '
    ...
    {
        if (isset($data['image'])) {
            $data['image'] = $this->handleFile($data['image'], 'Document');
        }

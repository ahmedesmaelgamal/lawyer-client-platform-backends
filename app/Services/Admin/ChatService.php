...
use App\Models\Chat as ObjModel;
...
{
    protected string $folder = 'admin/chat';
    protected string $route = 'chats';
        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($obj)
                ->addColumn('action', function ($obj) {
                    ...
                    if (Auth::user()->can("update_chat_management")) {
                        $buttons .= '
                    ...
                    if (Auth::user()->can("delete_chat_management")) {
                        $buttons .= '
    ...
    {
        if (isset($data['image'])) {
            $data['image'] = $this->handleFile($data['image'], 'Chat');
        }

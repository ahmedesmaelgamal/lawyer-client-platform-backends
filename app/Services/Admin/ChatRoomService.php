...
{
    protected string $folder = 'admin/chat_room';
    protected string $route = 'chat_rooms';
        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($obj)
                ->addColumn('action', function ($obj) {
                    ...
                    if (Auth::user()->can("update_chat_room_management")) {
                        $buttons .= '
                    ...
                    if (Auth::user()->can("delete_chat_room_management")) {
                        $buttons .= '
    ...
    {
        if (isset($data['image'])) {
            $data['image'] = $this->handleFile($data['image'], 'ChatRoom');
        }

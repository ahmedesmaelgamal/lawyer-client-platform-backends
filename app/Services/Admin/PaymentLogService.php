...
{
    protected string $folder = 'admin/payment_log';
    protected string $route = 'payment_logs';
        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($obj)
                ->addColumn('action', function ($obj) {
                    ...
                    if (Auth::user()->can("update_payment_log_management")) {
                        $buttons .= '
                    ...
                    if (Auth::user()->can("delete_payment_log_management")) {
                        $buttons .= '
    ...
    {
        if (isset($data['image'])) {
            $data['image'] = $this->handleFile($data['image'], 'PaymentLog');
        }

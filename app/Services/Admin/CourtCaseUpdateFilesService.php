...
use App\Models\CourtCaseUpdateFiles as ObjModel;
use App\Services\BaseService;
use Illuminate\Support\Facades\Auth;
use Yajra\DataTables\DataTables;

class CourtCaseUpdateFilesService extends BaseService
{
    protected string $folder = 'admin/court_case_update_files';
    protected string $route = 'court_case_update_filess';
    ...
    {
        if (isset($data['image'])) {
            $data['image'] = $this->handleFile($data['image'], 'CourtCaseUpdateFiles');
        }

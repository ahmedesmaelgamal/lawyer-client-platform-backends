...
use App\Models\BlogComment as ObjModel;
...
{
    protected string $folder = 'admin/blog_comment';
    protected string $route = 'blog_comments';
        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($obj)
                ->addColumn('action', function ($obj) {
                    ...
                    if (Auth::user()->can("update_blog_comments_management")) {
                        $buttons .= '
                    ...
                    if (Auth::user()->can("delete_blog_comments_management")) {
                        $buttons .= '
    ...
    {
        if (isset($data['image'])) {
            $data['image'] = $this->handleFile($data['image'], 'BlogComment');
        }

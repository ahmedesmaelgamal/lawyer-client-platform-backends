...
use App\Models\LawyerSpeciality as ObjModel;
use App\Services\BaseService;
use Illuminate\Support\Facades\Auth;
use Yajra\DataTables\DataTables;

class LawyerSpecialityService extends BaseService
{
    protected string $folder = 'admin/lawyer_speciality';
    protected string $route = 'lawyer_speciality';
        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($obj)
                ->editColumn('lawyer_id', function ($obj) {
                    return $obj->lawyer_id;
                })
                ->editColumn('special_id', function ($obj) {
                    return $obj->special_id;
                })
    ...
    {
        if (isset($data['image'])) {
            $data['image'] = $this->handleFile($data['image'], 'LawyerSpeciality');
        }
